...
const validator = (() => {
    ...
    }, _errorFactory)) && (undefined === input.contextWindow || "number" === typeof input.contextWindow || _assertGuard_1._assertGuard(_exceptionable, {
        method: "typia.createAssertEquals",
    ...
    }, _errorFactory)) && (undefined === input.model || "string" === typeof input.model || _assertGuard_1._assertGuard(_exceptionable, {
        method: "typia.createAssertEquals",
        path: _path + ".model",
        expected: "(string | undefined)",
        value: input.model
