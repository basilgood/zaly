...
## [0.0.6](https://github.com/basilgood/zaly/compare/cli-v0.0.5...cli-v0.0.6) (2026-08-30)
...
* **agent:** tell the main agent where its session transcript lives ([6c3c7c5](https://github.com/basilgood/zaly/commit/6c3c7c5c674e502a66b3c7786c06b74d54e3cfc9))
...
* **cli/help:** help for actions / keys ([fa1f653](https://github.com/basilgood/zaly/commit/fa1f6537d79fa72b91af29bb79fc0cdd29e3b286))
...
* **cli/resources:** added /resources --project|--user ([64795bd](https://github.com/basilgood/zaly/commit/64795bddc35b2a68c9839b004fba861753ed3400))
...
* **cli/stream:** configure which tools to show as collapsed ([524e33a](https://github.com/basilgood/zaly/commit/524e33a854d6c1750f892750201d865640f44387))
* **cli/theme:** live theme preview and use custom theme resources ([8291f96](https://github.com/basilgood/zaly/commit/8291f9683f144ad73cd1ccf74a5556b41027323e))
* **cli/tree:** tree filter settings ([862ff1d](https://github.com/basilgood/zaly/commit/862ff1d3256a05878d8eab9ef6a2b97fe00b8a09))
* **cli/ui:** allow disabling reasoning in the ui ([7ccf951](https://github.com/basilgood/zaly/commit/7ccf95101509770ae2135dfd64a24afb50ef05a7))
* **cli/user:** user message meta markdown?:boolean ([0130773](https://github.com/basilgood/zaly/commit/013077341ce014feb2c3f553336b9bf79f4cc4b0))
...
* **cli:** added /config ([47076e2](https://github.com/basilgood/zaly/commit/47076e25411fe39862b32a9d1ce74d9838b3cf50))
...
* **cli:** keep track of lastModel in state.json ([fa4a300](https://github.com/basilgood/zaly/commit/fa4a300a8e6d9cce3ee1330d7393d96a14ce18f8))
* **cli:** live propagate listHeight to autocomplete/picker ([34c38fa](https://github.com/basilgood/zaly/commit/34c38fa76b3c34c83ff1fba23d0bb7be4a9304da))
* **cli:** manage resources (enabled/disable) ([8e1f09f](https://github.com/basilgood/zaly/commit/8e1f09f67bc0d94ca6073d036c1b6fe7d94fdf53))
...
* **config:** add state:JsonFile to ConfigManager ([190e789](https://github.com/basilgood/zaly/commit/190e78965ae64f8f8e5cf3eb55a782bd529185ce))
...
* **config:** allow configuring a skill/command action prefix ([e9502db](https://github.com/basilgood/zaly/commit/e9502dbec293050cbae2bfed149e8edc65d2bba7))
...
* **config:** packages support (npm & git) ([2fbe300](https://github.com/basilgood/zaly/commit/2fbe30074676f7bebd8541379fbda2e95de0dc88))
* **config:** pass resource excludes from flags ([696fdb3](https://github.com/basilgood/zaly/commit/696fdb3148f1e350cf59213116e1230e0f8b6bb3))
...
* **config:** resource management ([6b5b561](https://github.com/basilgood/zaly/commit/6b5b561237fa14b4c94e02ab465fff83b7d7c5b2))
* **config:** ui.listHeight and ui.treeHeight ([673b265](https://github.com/basilgood/zaly/commit/673b26515286041a5015e8104f9763a6b2dc99df))
...
* **tui/images:** allow disabling image rendering ([3fb7282](https://github.com/basilgood/zaly/commit/3fb7282e75ea7fb9a56d768cb749bd795ef0e7ea))
* **tui/picker:** opts.clearInput ([055bdc6](https://github.com/basilgood/zaly/commit/055bdc676708772579f83742345163933a973024))
...
* **tui/reactive:** createRef now has an optional onSet ([ae92b41](https://github.com/basilgood/zaly/commit/ae92b41325f0974290dfb8f1799027928572e656))
...
* **app:** logger entries need left-padding:1 ([18276b6](https://github.com/basilgood/zaly/commit/18276b65934a457cbd727cfe0fc6bbde06b15b87))
* **cli/app:** reset config on reload ([bd35aec](https://github.com/basilgood/zaly/commit/bd35aecc430694bae892ed09bf7491bbaea03927))
* **cli/composer:** always update/refresh input history ([cfcf630](https://github.com/basilgood/zaly/commit/cfcf63023ba1488637f788022f5316044b386541))
...
* **cli/tools:** implemented ToolRenderer.call ([df4eef2](https://github.com/basilgood/zaly/commit/df4eef2fd087e7853dfe5bde0fb19bac70a7a96e))
...
* **cli/ui:** propagate listHeight to autocomplete ([4a9e1c1](https://github.com/basilgood/zaly/commit/4a9e1c15de8aa7c91dbcf16c60dbadc0cce5c56b))
...
* **cli:** make config a getter instead of async loaded ([38d697b](https://github.com/basilgood/zaly/commit/38d697b1e89267a4d031b894078f0be276259b6e))
* **cli:** move theme/model actions to separate file ([e8a1cd7](https://github.com/basilgood/zaly/commit/e8a1cd710b0924ab3b5d81d6beef21222fc0d843))
* **config:** added ResolvedSettings inferred from default settings ([fd8660d](https://github.com/basilgood/zaly/commit/fd8660def74a22c83907f9faae34e8207540476a))
* **config:** ConfigManager ([149a353](https://github.com/basilgood/zaly/commit/149a353de12a5e973172e5fead9120de7bec0bc7))
